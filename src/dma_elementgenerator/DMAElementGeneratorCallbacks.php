...
class DMAElementGeneratorCallbacks extends \Backend
{
	...
	public function content_onload($dc)
	{
		...
		// TODO: This is a hotfix for the MultiColumnWizard in conjunction with the filetree widget
		// More testing needed!
		try {
			// Calling MultiColumnWizardHelper::supportModalSelector again after generateDCA was executed
			// as the fields needed by supportModalSelector are generated by generateDCA
			$this->import('MultiColumnWizardHelper');
			$this->MultiColumnWizardHelper->supportModalSelector('tl_content');
		} catch (Exception $e) {
